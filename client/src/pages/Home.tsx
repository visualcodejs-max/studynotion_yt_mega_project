...
const Home = () => {
  ...
  return (
    <div className="w-11/12 mx-auto">
      ...
      <div className="pt-20 w-[50%] mx-auto">
        <div className="flex flex-col gap-9">
          ...
          <div className="w-full flex justify-center">
            <div className="text-[#F1F2FF] font-semibold text-4xl leading-11 tracking-[-2%] flex items-center gap-2">
              <p>Empower Your Future with</p>
              <HighlightedText text="Coding School" />
            </div>  
          </div> 
          
          {/* para */}
          <div className="w-full">
            <p className="text-[#838894] text-center font-medium">With our online coding courses, you can learn at your own pace, from anywhere in the world, and get access to a wealth of resources, including hands-on projects, quizzes, and personalized feedback from instructors.</p>
          </div>
